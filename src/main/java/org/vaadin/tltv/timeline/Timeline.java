...
public class Timeline extends Component {
	...
	public void setStartDate(LocalDate startDate) {
		getElement().setAttribute("startdatetime", dateTimeFormatter
				.format(resetTimeToMin(startDate.atStartOfDay())));		
		updateTimelineStartTimeDetails();
	}
	
	public void setStartDateTime(LocalDateTime startDateTime) {
		getElement().setAttribute("startdatetime", dateTimeFormatter
				.format(resetTimeToMin(startDateTime)));
		updateTimelineStartTimeDetails();
	}
	 ...
	 * 
	 * @return ID of scroll container if set via {@link #setScrollContainerId(String)}.
	 */
